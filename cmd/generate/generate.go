...
func main() {
	packages := []schemagen.PackageDescriptor{
		...
		{"k8s.io/kubernetes/pkg/apis/storage/v1", "io.fabric8.kubernetes.api.storage", "kubernetes_storage_"},
		{"k8s.io/apimachinery/pkg/runtime", "io.fabric8.kubernetes.api.runtime", "kubernetes_runtime_"},
		{"k8s.io/apimachinery/pkg/util/intstr", "io.fabric8.kubernetes.api.model", "kubernetes_util_"},
		{"k8s.io/apimachinery/pkg/api/resource", "io.fabric8.kubernetes.api.model", "kubernetes_resource_"},
		{"k8s.io/apimachinery/pkg/apis/meta/v1", "io.fabric8.kubernetes.api.model", "kubernetes_meta_"},
